...
DRACULA = Theme(
    ...
    commit      = fg(155, 156, 162),
    session     = fg(155, 156, 162),
    skills      = fg(241, 250, 140),
    time        = fg(155, 156, 162),
    tok         = fg(139, 233, 253),
    tok_dim     = fg(144, 146, 152),
    tok_day     = fg(139, 233, 253),
    tok_day_dim = fg(144, 146, 152),
    cost        = fg(255,  85,  85),
    bar_fill    = fg( 80, 250, 123),
    bar_empty   = fg(  0,   0,   0),
    dim_green   = fg( 80, 250, 123),
    label       = fg(155, 156, 162),
    ctx         = fg(139, 233, 253),
    ctx_dim     = fg(155, 156, 162),
...
# Dracula on a light background: keeps Dracula's hues, darkens TEXT slots to
# clear WCAG AA against off-white. `models` keeps Dracula's original pill
# anchors unmodified — those already clear BG_LUM_THRESHOLD.
DRACULA_LIGHT = Theme(
    name        = 'dracula-light',
    ...
    bar_empty   = fg(198, 193, 180),  # light, not Dracula's black — track should read as absence
    dim_green   = fg(  0, 127,  32),
    label       = fg( 98, 114, 164),
    ctx         = fg(  0, 119, 144),
    ctx_dim     = fg( 98, 114, 164),
    white_brt   = fg( 40,  42,  54),  # 13.77:1  light themes invert: max emphasis = darkest tone
    arrow       = fg(  0, 127,  32),
    dirty       = fg(220,   0,   0),
    ...
    warn        = fg(105, 115,   0),
    alert       = fg(220,   0,   0),
    yellow      = fg(105, 115,   0),  # olive: yellow can't be both recognizable and readable on off-white
    ...
    # Light-theme pair (10,10,10)/(250,250,250); dark themes use (15,15,15)/
    # (235,235,235) — ops/demo.py buckets renders on this exact difference.
    pill_fg_dark  = ( 10,  10,  10),
    pill_fg_light = (250, 250, 250),
    ...
    grey_rgb    = (198, 193, 180),  # "spent" fade target, light not dark
    spark_stops = (
        (0.00, (150,   0,   0)),
        (0.50, (185,   0,   0)),
        (1.00, (220,   0,   0)),
...
GRUVBOX_DARK = Theme(
    ...
    commit      = fg(150, 145, 130),
    session     = fg(150, 145, 130),
    skills      = fg(215, 153,  33),
    time        = fg(150, 145, 130),
    tok         = fg(104, 157, 106),
    tok_dim     = fg(140, 136, 123),
    tok_day     = fg(142, 192, 124),
    tok_day_dim = fg(140, 136, 123),
    cost        = fg(251,  73,  52),
    bar_fill    = fg(152, 151,  26),
    bar_empty   = fg( 40,  40,  40),
    dim_green   = fg(152, 151,  26),
    label       = fg(150, 145, 130),
    ctx         = fg(104, 157, 106),
    ctx_dim     = fg(150, 145, 130),
...
NORD = Theme(
    ...
    commit      = fg(148, 154, 165),
    session     = fg(148, 154, 165),
    skills      = fg(235, 203, 139),
    time        = fg(148, 154, 165),
    tok         = fg(136, 192, 208),
    tok_dim     = fg(139, 145, 157),
    tok_day     = fg(143, 188, 187),
    tok_day_dim = fg(139, 145, 157),
    cost        = fg(191,  97, 106),
    bar_fill    = fg(163, 190, 140),
    bar_empty   = fg( 59,  66,  82),
    dim_green   = fg(163, 190, 140),
    label       = fg(148, 154, 165),
    ctx         = fg(136, 192, 208),
    ctx_dim     = fg(148, 154, 165),
...
ONE_DARK = Theme(
    ...
    commit      = fg(128, 133, 143),
    session     = fg(128, 133, 143),
    skills      = fg(209, 154, 102),
    time        = fg(128, 133, 143),
    tok         = fg( 86, 182, 194),
    tok_dim     = fg(121, 126, 136),
    tok_day     = fg( 86, 182, 194),
    tok_day_dim = fg(121, 126, 136),
    cost        = fg(224, 108, 117),
    bar_fill    = fg(152, 195, 121),
    bar_empty   = fg( 30,  33,  39),
    dim_green   = fg(152, 195, 121),
    label       = fg(128, 133, 143),
    ctx         = fg( 86, 182, 194),
    ctx_dim     = fg(128, 133, 143),
    white_brt   = fg(255, 255, 255),
...
SOLARIZED_DARK = Theme(
    ...
    pwd         = fg( 38, 139, 210),
    branch      = fg(133, 153,   0),
    commit      = fg( 88, 122, 130),
    session     = fg( 88, 122, 130),
    skills      = fg(181, 137,   0),
    time        = fg( 88, 122, 130),
    tok         = fg( 42, 161, 152),
    tok_dim     = fg( 81, 116, 125),
    tok_day     = fg(147, 161, 161),
    tok_day_dim = fg( 81, 116, 125),
    cost        = fg(203,  75,  22),
...
TOKYO_NIGHT = Theme(
    ...
    commit      = fg(118, 122, 142),
    session     = fg(118, 122, 142),
    skills      = fg(224, 175, 104),
    time        = fg(118, 122, 142),
    tok         = fg( 68, 157, 171),
    tok_dim     = fg(111, 114, 133),
    tok_day     = fg( 13, 185, 215),
    tok_day_dim = fg(111, 114, 133),
    cost        = fg(255, 122, 147),
    bar_fill    = fg(158, 206, 106),
    bar_empty   = fg( 50,  52,  74),
    dim_green   = fg(158, 206, 106),
    label       = fg(118, 122, 142),
    ctx         = fg( 68, 157, 171),
    ctx_dim     = fg(118, 122, 142),
...
PALENIGHT = Theme(
    ...
    commit      = fg(141, 144, 155),
    session     = fg(141, 144, 155),
    skills      = fg(255, 203, 107),
    time        = fg(141, 144, 155),
    tok         = fg(137, 221, 255),
    tok_dim     = fg(133, 136, 148),
    tok_day     = fg(163, 247, 255),
    tok_day_dim = fg(133, 136, 148),
    cost        = fg(255, 139, 146),
    bar_fill    = fg(195, 232, 141),
    bar_empty   = fg( 41,  45,  62),
    dim_green   = fg(195, 232, 141),
    label       = fg(141, 144, 155),
    ctx         = fg(137, 221, 255),
    ctx_dim     = fg(141, 144, 155),
    white_brt   = fg(255, 255, 255),
...
CATPPUCCIN_MOCHA = Theme(
    ...
    commit      = fg(133, 136, 157),
    session     = fg(133, 136, 157),
    skills      = fg(249, 226, 175),
    time        = fg(133, 136, 157),
    tok         = fg(148, 226, 213),
    tok_dim     = fg(124, 127, 147),
    tok_day     = fg(148, 226, 213),
    tok_day_dim = fg(124, 127, 147),
    cost        = fg(243, 139, 168),
    bar_fill    = fg(166, 227, 161),
    bar_empty   = fg( 69,  71,  90),
    dim_green   = fg(166, 227, 161),
    label       = fg(133, 136, 157),
    ctx         = fg(148, 226, 213),
    ctx_dim     = fg(111, 113, 132),
...
THEMES: dict[str, Theme] = {
    t.name: t for t in (
        CLAUDE_DARK, CLAUDE_LIGHT, CATPPUCCIN_LATTE, CATPPUCCIN_MOCHA,
        DRACULA, DRACULA_LIGHT, GRUVBOX_DARK, GRUVBOX_LIGHT, NORD,
        ONE_DARK, ONE_LIGHT, SOLARIZED_DARK, SOLARIZED_LIGHT,
        TOKYO_NIGHT, PALENIGHT,
    )
}
