...
#### Scenario: Running row is unchanged

- **WHEN** a subagent is still running
- **THEN** its row renders with the `▶` marker, live colours, and a live-ticking elapsed field exactly as before this change
