# justify-top-row Specification

## Purpose

Define how the wide-layout top content row distributes horizontal slack evenly across its active sections when `cfg.justify` is enabled.
